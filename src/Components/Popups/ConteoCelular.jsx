...
const ConteoCelular = () => {
    ...
    const [resumenCelulares, setResumenCelulares] = useState({ activos: 0, inactivos: 0 });
    ...
    const isActive = (celular) => {
        ...
        return inactiveTimeInMinutes < 5; // Menor a 5 minutos se considera activo
    };

    // Recalcular los totales cada vez que cambien los celulares
    useEffect(() => {
                        ...
                        <table className="w-full bg-white border border-gray-300 rounded-lg text-xs">
                            ...
                            <tbody>
                                <tr className="border-t">
                                    ...
                                    <td className="py-2 px-4 text-center text-blue-700">{resumenCelulares.activos}</td>
                                </tr>
                                <tr className="border-t">
                                    <td className="py-2 px-4 text-gray-700">Inactivos</td>
                                    <td className="py-2 px-4 text-center text-red-500">{resumenCelulares.inactivos}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
