...
const AddIssiModulo = ({ showModal, setShowModal, SelectedArea, setSelectedArea, tipoId, valorId, distancia }) => {
    ...
    useEffect(() => {
        if (SelectedArea) {
            ...
            const lat = SelectedArea.Longitud;
            const lng = SelectedArea.Latitud;
    ...
    return (
        <CustomModal Open={showModal} setOpen={setShowModal} handleClose={handleClose}>
            <div className="flex items-center mb-2">
                ...
                <h1 className='text-lg font-bold fl'>Vigilancia de Modulo</h1>
            </div>
