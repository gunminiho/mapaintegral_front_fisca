...
const AddIssiSostenimineto = ({ showModal, setShowModal, SelectedArea, setSelectedArea, tipoId, valorId, distancia }) => {
    ...
    useEffect(() => {
        if (SelectedArea) {
            ...
            // Se cambia por que turf lo detecta al revez
            const lat = SelectedArea.geometry.coordinates[0];
            const lng =SelectedArea.geometry.coordinates[1];

            formik.setFieldValue('latitud', lat);
            formik.setFieldValue('longitud', lng);
            formik.setFieldValue('punto_index', "");
            formik.setFieldValue('feature_index', "");
            formik.setFieldValue('options', {
                tipo: tipoId,
                valor: valorId,
                distancia: distancia,
                nombre: SelectedArea.Modulos
            });
  ...
  return (
    <CustomModal Open={showModal} setOpen={setShowModal} handleClose={handleClose}>
            <div className="flex items-center mb-2">
                <MyLocationRoundedIcon className="w-6 h-6 mr-2" />
                <h1 className='text-lg font-bold fl'>Vigilancia de Puestos de Seguridad</h1>
            </div>
...
export default AddIssiSostenimineto