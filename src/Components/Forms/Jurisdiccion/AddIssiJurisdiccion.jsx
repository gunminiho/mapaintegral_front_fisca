...
const AddIssiJurisdiccion = ({ showModal, setShowModal, SelectedArea, setSelectedArea, tipoId }) => {
    ...
    return (
        <CustomModal Open={showModal} setOpen={setShowModal} handleClose={handleClose}>
            <div className="flex items-center mb-2">
                ...
                <h1 className='text-lg font-bold fl'>Vigilancia de Jurisdiccion</h1>
            </div>
...
export default AddIssiJurisdiccion