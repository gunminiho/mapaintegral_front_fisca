...
const AddIssiArea = ({ showModal, setShowModal, SelectedArea, setSelectedArea, tipoId, valorId, distancia }) => {
    ...
    return (
        <CustomModal Open={showModal} setOpen={setShowModal} handleClose={handleClose}>
            <div className="flex items-center mb-2">
                ...
                <h1 className='text-lg font-bold fl'>Vigilancia de Area</h1>
            </div>
